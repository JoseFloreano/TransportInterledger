    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('COMMON_CONFIG')}
        >
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.navButton} onPress={() => navigation.navigate('COMMON_PAY_QR')}>
