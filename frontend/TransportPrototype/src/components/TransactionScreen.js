...
const TransactionRow = ({ origin, destiny, value }) => {
  return (
    <View style={styles.transactionRow}>
      <Text style={styles.transactionText}>{origin}</Text>
      <Text style={styles.transactionText}>{destiny}</Text>
      <Text style={styles.transactionText}>{value}</Text>
    </View>
  );
};
